...
class CartScreenViewController: UIViewController,CartScreenViewProtocol,UITableViewDelegate,UITableViewDataSource {
    var presenter: (any CartScreenPresenterProtocol)?
